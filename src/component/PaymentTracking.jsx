...
import { FaRupeeSign, FaCalendarAlt, FaDownload, FaEye, FaCheck, FaClock, FaExclamationTriangle, FaCreditCard } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-green-800 mb-2">Payment Management</h1>
          <p className="text-gray-600">Monitor payments and process transactions securely</p>
        </div>
